...
namespace SDGH2_7
{
	partial class Acerca_de
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Escuela: CBTis 217";
			// 
			// label2
			// 
			...
			this.label2.Text = "Materia: Aplica Metodologías Ágiles para el Desarrollo de Software";
			// 
			// label3
			// 
			...
			this.label3.Text = "Nombre del programa: SDGH2_7 (SharpDevelop y GitHub proyecto, Tarea 2.7)";
			// 
			// label4
			// 
			...
			this.label4.Text = "Versión: 3";
			// 
			// label5
			// 
			this.label5.Location = new System.Drawing.Point(23, 173);
			this.label5.Name = "label5";
			this.label5.Size = new System.Drawing.Size(432, 38);
			this.label5.TabIndex = 4;
			this.label5.Text = "Fecha de creación: 22/10/24";
			// 
			// label6
			// 
			...
			this.label6.Text = "Nombre de autor: Juan Rafael González Díaz";
			// 
			// Acerca_de
			// 
